 ...
 * @author hxd
 *<br>这是一个TokenMetadata的数据示例：（三个正常节点，每个num_token=3）
 * toString:<br>
 * Normal Tokens:
...
public class TokenMetadata
{
	 ...
	 * 按照目前的写法,这里其实总是一个SortBiMultiValMap对象<br>
     ...
     * <br>一个示例：{/192.168.3.226=f21f2d72-5c5b-4e9d-9e2c-46b9c4589644, /192.168.3.225=4f0afbaf-c90c-48c1-a571-e79125356e2b, /166.111.82.41=8fe08b5e-d39a-47dc-a471-827f26b59960}*/
    ...
    /**示例：[-7613243433252172280, 97968597608324826, 617887885317243447, 1319220758109565542, 1568757730276352480, 3744912842414974619, 3909925557451044612, 4848558567716775630, 5597558394803796696]*/
    private volatile ArrayList<Token> sortedTokens;
    /**示例：{/192.168.3.226=(datacenter1,rack1), /192.168.3.225=(datacenter1,rack1), /166.111.82.41=(datacenter1,rack1)}*/
    private final Topology topology;
    /** list of subscribers that are notified when the tokenToEndpointMap changed <br> 每个ks有一个复制策略（如SimpleStrategy或者LocallyStrategy），每个复制策略中的name字段指明了这个对象是哪个ks的。每个复制策略会在这里注册为subscriber。*/
...
/**
 * 添加到subscribers中，目前发现有strategy进行了注册（在新生成一个strategy的时候 就进行注册 ）
 * @param subscriber
 */
